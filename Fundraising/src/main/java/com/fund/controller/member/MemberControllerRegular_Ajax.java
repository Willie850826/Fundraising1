...
public class MemberControllerRegular_Ajax {
     ...
     * @return
     */
	@RequestMapping(path="/memberEmailRegularLogin" ,produces = "text/html; charset=UTF-8")
	public @ResponseBody String memberEmailRegularLoging( @RequestParam String email ) {
