...
<!-- 商品圖片 -->
					    ...
					    <div class="form-group">
							...
							<input type="text"
								...
								id="productItemNO" value="${getProduct.productItemNO}">
						</div>
					    ...
					    <div class="form-group">
							...
							<input type="text"
								...
								id="productName" value="${getProduct.productName}">
						</div>
					...
					<div class="form-group">
							...
							<input type="text"
								...
								id="productPrice" value="${getProduct.productPrice}">
						</div>
						...
						<div class="form-group">
							...
							<input type="text"
								...
								id="productStatus" value="${getProduct.productStatus}">
						</div>
...
<%-- 								id="productPf" value="${getProduct.productPf}"> --%>
								<label>商品簡介</label>
								<textarea class="form-control" style="height: 100px;width: 390px" name="productPf" >${getProduct.productPf}</textarea>
						</div>
