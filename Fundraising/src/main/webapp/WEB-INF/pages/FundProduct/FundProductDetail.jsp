...
body {
	background: linear-gradient(rgba(255, 255, 255, 0.5),
		...
		url('${pageContext.request.contextPath}/images/productPic/bg6.png')
...
<body class="imgbg">
	...
	<div class="container">
		<div class="row bg-store "
			style="border-width: thin; height: 125px; border: 2px solid rgba(0, 0, 0, 0.1); background-clip: padding-box; margin-top: 130px">
